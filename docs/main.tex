...
\author{\fnm{Harry Hongrui} \sur{Zhang}}
...
Consider a salesman that wants to visit a number of cities around the world. The salesman does not have to visit the cities in any particular order, but after the salesman has visited all the desired cities, the salesman has to return to the city it started out at. 
...
- Statement
- Distnace euclidian
- the goal is to minimize the total distance when visiting all cities and coming back to the initial city

It is a NP-hard problem and there are a lot of different heuristic solutions. Some solutions might work better in some situations than others. In this research different algorithms are going to be tested on different test cases
...
RQ: What algorithm could find the shortest path in a weighted graph, in a set amount of time?
...
\bibliography{docs/references}% common bib file

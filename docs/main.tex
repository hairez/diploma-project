...
\begin{figure}[ht]
 \centering
 \includegraphics[scale=.5]{docs/pictures/tsp.png}
 \caption{TSP is interpreted as a graph where a path is found. }
\end{figure}

\newline

The travelling salesman problem could also be interpreted as a weighted graph with a number of nodes. 
\newline

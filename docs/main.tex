...
Genetic algorithms are used to iteratively improve any solution. 
...
Similar to the Genetic algorithm with random swapping, this algorithm also starts off wiht a randomly generated path. Then two random edges are randomly chosen and swapped. 
